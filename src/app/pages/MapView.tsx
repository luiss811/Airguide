...
export default function MapView() {
  ...
  // Determinar qué contenido mostrar según el usuario
  ...
  return (
    <div className="h-screen flex flex-col">
      ...
      <div className="flex-1 relative">
        ...
        {selectedMarker && (
          <div className="absolute top-4 right-4 bg-white dark:bg-gray-800 rounded-lg shadow-xl p-4 w-80 max-h-96 overflow-y-auto z-[1000]">
            ...
            {selectedMarker.type === 'evento' && (
              <>
                <div className="mb-3">
                  <span className="inline-flex items-center gap-1 px-2 py-1 bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300 text-xs rounded-full mb-2">
        ...
        {/* Botón para mostrar panel de rutas - Solo para usuarios autenticados */}
        {canCreateRoutes && (
          <>
            <button
            ...
            {showRoutePanel && (
              <div className="absolute bottom-20 right-4 bg-white dark:bg-gray-800 rounded-lg shadow-xl p-4 w-80 z-[1000]">
                <div className="flex items-start justify-between mb-3">
